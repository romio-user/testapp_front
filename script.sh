...
sed -i "s#EXECUTION_ROLE_ARN#${env.EXECUTION_ROLE_ARN}#g" front_task_definition.json
sed -i "s#AWS_DEFAULT_REGION#${env.AWS_DEFAULT_REGION}#g" front_task_definition.json
